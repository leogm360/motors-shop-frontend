export const getInputStateClasses = (hasError: boolean) => {
  const baseClasses =
    "text-base border-2 rounded w-full h-12 px-4 placeholder:text-base outline-none transition-colors duration-300";
